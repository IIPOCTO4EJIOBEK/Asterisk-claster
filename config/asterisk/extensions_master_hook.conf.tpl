...
;
; Диапазоны номеров: по умолчанию 3- и 4-значные. Если у вас другой план
; нумерации (например, 5-значный с кодом площадки), добавьте шаблон по
; образцу ниже — и не забудьте про конфликты кодов площадок из аудита.
