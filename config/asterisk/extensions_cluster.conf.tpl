...
; Имя локального транка провайдера. Заполняется setup-local-trunk.sh в
; globals_custom.conf; пустое значение означает «своего транка нет,
; исходящие вести через мастер».
LOCAL_TRUNK=
